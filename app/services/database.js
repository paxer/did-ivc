...
export default Service.extend({
  ...
  init() {
    let quotes = [
      ...
      "люди заботливых пожилых людей взаимностью",
      "мало, а может хватит",
      ...
      "посмотрите какой он замечательный специалист",
